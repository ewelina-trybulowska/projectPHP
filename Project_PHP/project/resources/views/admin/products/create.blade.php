                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="post" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <x-input id="brand" class="block mt-1 w-full" type="text" name="brand" :value="old('brand')" autofocus />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="price" class="block mt-1 w-full" type="number" min="0" max="10000000" name="price" :value="old('price')"/>
                        </div>
